...
<script>
  document.getElementById('checkout').onclick = function(){
    Swal.fire({
      title: 'Segera Transfer Untuk Pembayaran No Rekening 0232932939 an Arhan Doni, Kami akan Menghubungi Anda',
      ...
      window.location = 'https://api.whatsapp.com/send/?phone=6281211580453&text&app_absent=0';
    });
  }
</script>
